...
function extractErrorMessage(err: unknown): string {
    if (!err || typeof err !== 'object') return 'Access Denied. Please verify your credentials.';
...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess, onSwitchToRegister }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Token geldiyse çerez kalkanını aşmak için kaydet
            if ((data as any).token) {
                localStorage.setItem('gorenel_token', (data as any).token);
            }
        ...
        >
            <div className="space-y-6">
                <div className="space-y-1.5">
                    ...
                    <p className="text-sm text-white/70">Use your credentials or continue with SSO.</p>
                </div>

  ...
  en: {
    translation: {
      ...
      "api_keys_manager": {
        ...
        "os_linux": "Linux",
        "os_mac": "macOS",
        "magic_command_note": "Downloads the CLI, installs it, and starts a tunnel — no extra steps.",
  ...
  tr: {
    translation: {
      ...
      "api_keys_manager": {
        ...
        "os_linux": "Linux",
        "os_mac": "macOS",
        "magic_command_note": "CLI’yi indirir, kurar ve tüneli başlatır; ekstra adım gerekmez.",

...
const resources = {
  en: {
    translation: {
      ...
      "landing": {
        "hero_badge": "AI-Powered Secure Tunneling",
        "title": "Localhost is now",
        "title_accent": "Production-Grade",
        "subtitle": "Stop using dumb tunnels. Secure your local services with AI Protocol Intelligence, real-time traffic inspection, and zero-trust edge policies.",
        ...
        "ai_title": "AI Protocol Intelligence",
        "ai_subtitle": "Don't just pipe traffic. Understand it.",
        "ai_desc": "Gorenel analyzes every frame using dual ML models. Isolation Forest catches point anomalies while Autoencoder detects complex behavioral shifts. Zero configuration, maximum security.",
        "comparison_title": "Why Gorenel?",
        "comparison_subtitle": "The smart choice for modern developers who care about security and observability.",
  ...
  tr: {
    translation: {
      ...
      "landing": {
        "hero_badge": "Yapya Zeka Destekli Güvenli Tünelleme",
        "title": "Localhost Artık",
        "title_accent": "Prodüksiyon Seviyesinde",
        "subtitle": "Basit tünelleri unutun. AI Protokol Zekası, gerçek zamanlı trafik izleme ve zero-trust güvenlik politikalarıyla yerel servislerinizi koruyun.",
        ...
        "ai_title": "AI Protokol Zekası",
        "ai_subtitle": "Sadece trafiği aktarmayın. Onu anlayın.",
        "ai_desc": "Gorenel, her isteği çift ML modeliyle analiz eder. Isolation Forest anlık hataları yakalarken, Autoencoder karmaşık davranış değişikliklerini tespit eder. Sıfır konfigürasyon, maksimum güvenlik.",
        "comparison_title": "Neden Gorenel?",
        "comparison_subtitle": "Güvenlik ve gözlemlenebilirliğe önem veren modern geliştiriciler için akıllı seçim.",
